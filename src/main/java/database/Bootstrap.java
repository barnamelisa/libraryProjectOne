...
public class Bootstrap {
    ...
    private static void dropAll() throws SQLException {
        for (String schema : SCHEMAS) {
            ...
            String[] dropStatements = {
                    "TRUNCATE `role_right`;", // sterge tot continutul unei tabele
                    "DROP TABLE `role_right`;", // sterge tabela efectiv din bd
                    "TRUNCATE `right`;",
                    "DROP TABLE `right`;",
                    "TRUNCATE `user_role`;",
    ...
    private static void bootstrapRoleRight() throws SQLException {
        ...
        for (String role : rolesRights.keySet()) {
            Long roleId = rightsRolesRepository.findRoleByTitle(role).getId(); // returnam din bd rolul id-ului asociat

            for (String right : rolesRights.get(role)) {
                Long rightId = rightsRolesRepository.findRightByTitle(right).getId();// returnam din bd dreptul id-ului asociat
