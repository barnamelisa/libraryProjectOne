...
public class Constants {
    ...
    public static Map<String, List<String>> getRolesRights() {
        ...
        rolesRights.get(ADMINISTRATOR).addAll(Arrays.asList(RIGHTS)); // administrator are toate rolurile
    ...
    public static class Tables {
        ...
        public static final String[] ORDERED_TABLES_FOR_CREATION = new String[]{USER, ROLE, RIGHT, ROLE_RIGHT, USER_ROLE, ORDERS,
                BOOK};
    }
